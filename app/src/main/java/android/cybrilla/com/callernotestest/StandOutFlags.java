...
public class StandOutFlags {
     ...
     * {@link StandOutWindow#(int)},
     * {@link StandOutWindow#(int)}, and
     * {@link StandOutWindow#(int)} are implemented, and that
     ...
     * {@link Window#(View, int)} on the view returned by the
     * implementation.
     *
     * @see {@link Window#(View, int)}
     */
     ...
     * implementation.
     *
     * @see {@link StandOutWindow#(View, int)}
     */
